...
//		Planner_ID = Integer.parseInt(Env.getContext(getCtx(), "#AD_User_ID"));
	...
	private void createRecords (int AD_Client_ID, int AD_Org_ID,int S_Resource_ID, int M_Warehouse_ID) throws SQLException
	{
		...
		System.out.println("Insert from M_ForecastLine++++++++++++++++++++++++");
		List<Object> params = new ArrayList<Object>();
		...
		System.out.println("Insert from C_OrderLine++++++++++++++++++++++++");
		...
		System.out.println("Insert from M_RequisitionLine++++++++++++++++++++++++");
		...
		System.out.println("Insert from PP_Order++++++++++++++++++++++++");
		...
		System.out.println("Insert from PP_Order_BOMLine++++++++++++++++++++++++");
		sql_insert = " SELECT t.ad_org_id,"
